...
@def hascode = true
@def rss = "My publications"
@def rss_pubdate = Date(2019, 5, 1)

@def tags = ["syntax", "code", "image"]

# Publications
For my complete list of publications check out my google scholar [page](https://scholar.google.com/citations?user=LWGshtQAAAAJ&hl=en&oi=ao)
